...
url-latency-benchmark=𓅿回國꧂, server-tag-regex=(?=.*(回國|中國|中国|🇨🇳|CN|Cn|cn|(?i)China))^((?!(🇦🇺|🇺🇸|🇮🇳|印度尼西亚|🇰🇷|日本|(?i)香港|台湾|浙江|澳大利亚|巴西|🇨🇦|🏁|俄罗斯|丹麦|欧盟|🇸🇬|🇷🇺|更多节点关注|🇭🇰|🇬🇧|🇯🇵|🇱🇹|🇮🇷|🇪🇸|🇧🇩|🇳🇱|🇺🇦|🇱🇺|🇸🇬|🇩🇪|🇫🇮|🏁|🇨🇾|🇫🇷|🇦🇲|VN|🇻🇳|IN|🇨🇦|🇧🇿|🇸🇪|ID|🇮🇩)).)*$, check-interval=600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/China.png
...
url-latency-benchmark=𓅿日本꧂, resource-tag-regex=A||, server-tag-regex=(?=.*(?i)(日本|🇯🇵|JP|Jp|jp|Japan|Japan))^((?!(🇦🇺|🇮🇳|印度尼西亚|日本|(?i)🇰🇷|香港|台湾|浙江|澳大利亚|巴西|🇨🇦|🏁|俄罗斯|丹麦|欧盟|🇸🇬|🇷🇺|更多节点关注|🇭🇰|🇨🇳|🇬🇧|🇱🇹|🇮🇷|🇪🇸|🇧🇩|🇳🇱|🇺🇦|🇱🇺|🇸🇬|🇩🇪|🇫🇮|🏁|🇨🇾|🇫🇷|🇦🇲|VN|🇻🇳|IN|🇨🇦|🇧🇿|🇸🇪|ID|🇮🇩)).)*$, check-interval=600, tolerance=5, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Japan.png
...
url-latency-benchmark=𓅿法國꧂, server-tag-regex=(?=.*(法|france|fr|FR|Fr|🇫🇷|(?i)French Republic))^((?!(🇦🇺|🇮🇳|印度尼西亚|日本|(?i)🇰🇷|香港|台湾|浙江|澳大利亚|巴西|🇨🇦|🏁|俄罗斯|丹麦|欧盟|🇸🇬|美国|更多节点关注|🇺🇸|🇨🇳|🇬🇧)).)*$, check-interval=600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/France.png
...
url-latency-benchmark=𓅿印度꧂, server-tag-regex=(?=.*(印度|🇮🇳|Ln|ln|LN|Lnd|India|भारत गणराज्य|(?i)The Republic of India))^((?!(🇦🇺|印度尼西亚|日本|(?i)🇰🇷|香港|台湾|浙江|澳大利亚|巴西|俄罗斯|丹麦|欧盟|🇸🇬|🇫🇷|美国|更多节点关注|🇺🇸|🇨🇳|🇬🇧)).)*$, check-interval=600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/India.png

url-latency-benchmark=𓅿泰國꧂, resource-tag-regex=A||, server-tag-regex=(?=.*(?i)(泰国|🇹🇭|曼谷|泰國TH|Th|th))^((?!(🇦🇺|日本|(?i)🇰🇷|香港|台湾|浙江|澳大利亚|巴西|俄罗斯|丹麦|欧盟|🇸🇬|🇫🇷|美国|更多节点关注|🇺🇸|🇨🇳|🇮🇳|🇬🇧)).)*$, check-interval=600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Thailand.png
...
url-latency-benchmark=𓅿菲利賓꧂, server-tag-regex=(?=.*(?i)(菲律宾|🇵🇭|PH|Ph|ph|Philippines|(?i)PH))^((?!(🇦🇺|日本|(?i)🇰🇷|🇸🇬|🇫🇷|美国|更多节点关注|🇺🇸|🇨🇳|🇮🇳|🇬🇧)).)*$, check-interval=600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Philippines.png

url-latency-benchmark=𓅿土爾其꧂, server-tag-regex=(?=.*(土耳其|🇹🇷|TR|Tr|tr|rus|(?i) Turkey))^((?!(🇦🇺|日本|(?i)🇰🇷|🇸🇬|🇫🇷|美国|更多节点关注|🇺🇸|🇨🇳|🇮🇳|🇬🇧)).)*$, check-interval=600, tolerance=0, alive-checking=false, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Turkey.png
