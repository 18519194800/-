...
#节点远程订阅，自行添加
[server_remote]
https://sub.shancloud.icu/api/v1/client/subscribe?token=7898fb05fa0aa86717f795b94f7b01ef, tag=🧜备🍊壹✈⋯🔆, update-interval=172800, opt-parser=true, enabled=true
...
https://www.efcloud.cc/api/v1/client/subscribe?token=d2e815aff694abeecfa9fdadb8e8e41d, tag=🧜备🍊壹✈⋯🔆, update-interval=172800, opt-parser=true, enabled=true
